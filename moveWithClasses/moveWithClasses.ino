...
public:
  ...
  void dip(int diptime, int wash_cycles) {
    ...
    rinse(wash_cycles);
    while (millis() < period + current_time) {
    }

    yMoveTime(opheight, true);
  }
  ...
  void calibrateY(){
    yMoveTime(18000, true);
    yMoveTime(11000, false);
  }
